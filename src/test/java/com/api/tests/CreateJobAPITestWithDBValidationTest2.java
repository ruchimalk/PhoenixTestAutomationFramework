...
public void setup() {
 ...
 customerAddress = new CustomerAddress("D 404", "Vasant Galaxy", "Bangur nagar", "Inorbit",
	...
	customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "134530332004900",
			"134530332004900", "134530332004900", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
