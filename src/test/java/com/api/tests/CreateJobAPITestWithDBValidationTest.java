...
public void setup() {
 ...
 customerAddress = new CustomerAddress("D 404", "Vasant Galaxy", "Bangur nagar", "Inorbit",
	...
	customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "134530332084901",
			"134530332084901", "134530332084901", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
...
int customerId= response.then().extract().body().jsonPath().getInt("data.tr_customer_id");
 ...
 CustomerProductDBModel customerProductDBData= CustomerProductDao.getProductInfoFromDatabase(productId);
	...
	Assert.assertEquals(customerProductDBData.getSerial_number(),customerProduct.imei2() );
