...
public class CreateJobBean {
	...
	public String toString() {
		return "CreateJobBean [mst_platform_id=" + mst_platform_id + ", mst_warrenty_status_id="
				+ mst_warrenty_status_id + ", mst_oem_id=" + mst_oem_id + ", customer__first_name="
				+ customer__first_name + ", customer__last_name=" + customer__last_name + ", customer__mobile_number="
				+ customer__mobile_number + ", customer__mobile_number_alt=" + customer__mobile_number_alt
				+ ", customer__email_id=" + customer__email_id + ", customer__email_id_alt=" + customer__email_id_alt
				...
				+ ", customer_product__mst_model_id=" + customer_product__mst_model_id + ", problems__id="
				+ problems__id + ", problems__remark=" + problems__remark + ", mst_service_location_id="
